...
export default params => {
  const { stateName, action, key = 'list', mapper = getListParamsFromProps, ignore = IGNORE_PARAMS } = params
  const mapStateToProps = state => ({ [key]: getDataFromState(stateName, state) })
